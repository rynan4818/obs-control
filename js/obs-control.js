...
let obs_camera_script_status = 'none';
...
function camera_script_status_update(data) {
  if (typeof data.other === "undefined") return;
  if (typeof data.other.CameraSongScript === "undefined") return;
  switch (data.other.CameraSongScript.status) {
    case 'songScript':
      obs_camera_script_status = 'songScript';
      break;
    case 'commonScript':
      obs_camera_script_status = 'commonScript';
      break;
    default:
      obs_camera_script_status = 'none';
      break;
  }
}

function camera_script_game_scene_name() {
  switch (obs_camera_script_status) {
    case 'songScript':
      if (obs_song_script_game_scene_name !== false) return obs_song_script_game_scene_name;
      break;
    case 'commonScript':
      if (obs_common_script_game_scene_name !== false) return obs_common_script_game_scene_name;
      break;
  }
  return obs_game_scene_name;
}
...
function obs_game_scene_change() {
  let game_scene_name = camera_script_game_scene_name();
...
ex_other.push((data) => {
  camera_script_status_update(data);
